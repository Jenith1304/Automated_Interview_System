...
import styles from '../styles/AutoInterview.module.css'
...
const AutoInterview = () => {
    return (
        // Afte Completion Of interview Interviewer will be redirected to verify given  score and change the score  to Score.jsx Page
        <div className={styles.callContainer}>
            <div className={styles.callLeft}>
                <div className={styles.callHeader}>
                    <h2>Defence Research <br />and Development Organisation</h2>
